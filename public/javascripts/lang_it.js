(function() {
   ProtoCalendar.LangFile['it'] = {
     ...
     MONTH_ABBRS: ['Gennaio','Febbraio','Marzo','Aprile','Maggio','Giugno','Luglio','Agosto','Settembre','Ottobre','Novembre','Dicembre'],
     WEEKDAY_ABBRS: ['Do','Lu','Ma','Me','Gio','Ve','Sa'],
     WEEKDAY_NAMES: ['Do','Lu','Ma','Me','Gio','Ve','Sa'],
     YEAR_LABEL: ' ',
     MONTH_LABEL: ' ',
